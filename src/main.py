from tkinter import *
from constants.shipTypes import *
...
# ship id text
ship_id_label: Label = Label(master= body, font=("Arial", 15), text="ship id").grid(row=1,column=1)
# ship id text field
ship_id_text_field: Label= Text(body, height=1, width=20).grid(row=1,column=2)
#ship type text
ship_type_label: Label =  Label(master= body, font=("Arial", 15), text="type").grid(row=2, column=1)
#ship type menu
